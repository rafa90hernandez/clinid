// C:\Users\rafae\clinid\api\src\public-credentials\dto\public-link-info-response.dto.ts

import { PublicLinkStatus } from '@prisma/client';
import { ApiProperty } from '@nestjs/swagger'; // Se você estiver usando Swagger
...
export class PublicLinkInfoResponseDto {
  ...
  @ApiProperty({
    description: 'URL para o QR Code que representa o link público.',
    required: false,
  })
  qrCodeUrl?: string; // Opcional, pois pode ser gerado no frontend ou backend
}